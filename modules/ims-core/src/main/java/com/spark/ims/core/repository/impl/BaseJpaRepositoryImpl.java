...
public class BaseJpaRepositoryImpl<T, ID extends Serializable>
    ...
    public <E extends T> void saveOrUpdateInBatch(Iterable<E> entitys) {
        ...
        FlushMode defaultMode = session.getFlushMode();
        ...
        session.setFlushMode(defaultMode);
        session.flush();
        session.clear();
    }
