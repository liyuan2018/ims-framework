...
//		String redisSessionId = "spring:session:sessions:" + sessionId;
//		Set<String> keys = stringRedisTemplate.keys("spring:session:sessions*");
//		
//		if (keys.contains(redisSessionId)) {
//			Session redisSession = sessionRepository.getSession(sessionId);
//			if (redisSession != null) {
//				UserInfo userInfo = (UserInfo) redisSession.getAttribute("user");
//				if (userInfo != null) {
